      ...
      <div class="proj-navigation">
        ...
        <div class="proj-navigation-inner">
          ...
          <svg class="proj-free-icon-1-1" fill="white" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="proj-dashboard" href="Dashboard.php">Dashboard</a>
          </div>
        </div>
        <div class="proj-content-left">
          <div class="proj-empty-parent">
            ...
            <div class="proj-registration-wrapper">
              <a class="proj-registration" href="Registration.php">Registration</a>
            </div>
          </div>
        </div>
