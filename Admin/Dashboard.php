...
<div>
  <div
    ...
    <section
      ...
      <div
        class="flex-1 flex flex-col items-start justify-start gap-[1.312rem] max-w-full mq750:min-w-full">
        <div
          class="self-stretch flex flex-row items-start justify-start gap-[1.25rem] mq750:flex-wrap">
          <div
            class="flex-1 rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border flex flex-col items-start justify-start pt-[1.375rem] px-[0rem] pb-[1.312rem] gap-[1.75rem] min-w-[9.375rem]">
            <div
              class="self-stretch h-[15rem] relative rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border hidden"></div>
            <div
              class="self-stretch flex flex-row items-start justify-start py-[0rem] px-[3.437rem]">
              <div
                class="flex-1 rounded-[8px] bg-[#00c8d2] flex flex-row items-start justify-start py-[0.5rem] px-[0.812rem] z-[1]">
                <div
                  class="h-[5rem] w-[5.625rem] relative rounded-[8px] bg-[#00c8d2] hidden"></div>
            ...
            <div
              class="self-stretch flex flex-col items-start justify-start gap-[0.562rem]">
        ...
        <div
          class="self-stretch flex flex-row items-start justify-start gap-[1.25rem] text-[1.375rem] mq750:flex-wrap">
          <div
            class="flex-1 rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid flex flex-col items-end justify-start pt-[1.25rem] px-[0rem] pb-[2.562rem] gap-[3.562rem] mq450:gap-[1.75rem]">
            <div
              class="self-stretch h-[16.75rem] relative rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border hidden"></div>
            <div
              class="self-stretch flex flex-col items-end justify-start gap-[2.25rem] mq450:gap-[1.125rem]">
              <div
                class="self-stretch flex flex-row items-start justify-end py-[0rem] pl-[0rem] pr-[0.187rem]">
                <b class="flex-1 relative z-[1] mq450:text-[1.125rem]">Ownership</b>
              </div>
              <div
                class="w-[17.75rem] flex flex-row items-start justify-start text-left text-[2.188rem] text-[#00c8d2]">
                <div
                  class="w-[7.5rem] relative font-extrabold inline-block shrink-0 z-[2] mq450:text-[1.313rem] mq1050:text-[1.75rem]">
                  80%
                </div>
                <div
                  class="flex-1 flex flex-col items-start justify-start pt-[0.625rem] px-[0rem] pb-[0rem] text-[1.125rem] text-[#004268]">
                  <b class="self-stretch relative z-[1]">Government</b>
                </div>
              </div>
            </div>
            <div
              ...
              <div
                class="flex-1 flex flex-col items-start justify-start pt-[0.625rem] px-[0rem] pb-[0rem] text-[1.125rem] text-[#004268]">
                <b class="self-stretch relative z-[1]">Private</b>
              </div>
            </div>
          </div>
          <div
            ...
            <div
              ...
              <div
                class="self-stretch flex flex-row items-start justify-end py-[0rem] pl-[0rem] pr-[0.187rem]">
                <b class="flex-1 relative z-[1] mq450:text-[1.125rem]">Institutional Character</b>
              </div>
              <div
                class="w-[17.75rem] flex flex-row items-start justify-start text-left text-[2.188rem] text-[#00c8d2]">
                <div
                ...
                <div
                  class="flex-1 flex flex-col items-start justify-start pt-[0.625rem] px-[0rem] pb-[0rem] text-[1.125rem] text-[#004268]">
                  <b class="self-stretch relative z-[1]">Free-Standing</b>
                </div>
              </div>
            </div>
            <div
              ...
              <div
                class="flex-1 flex flex-col items-start justify-start pt-[0.625rem] px-[0rem] pb-[0rem] text-[1.125rem] text-[#004268]">
                <b class="self-stretch relative z-[1]">Institution-Based</b>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="grid gap-[1.4rem]">
        ...
        <div
          class="self-stretch flex flex-row items-start justify-start gap-[1.25rem] text-center text-[#fdfdfd] mq450:flex-wrap">
          <div
            class="flex-1 rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[2.125rem] gap-[2.187rem] min-w-[12.438rem]">
            <div
              class="self-stretch h-[13.188rem] relative rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border hidden"></div>
            <div
              class="self-stretch rounded-t-[8px] rounded-b-[0px] bg-[#00acce] border-[#00acce] border-[1.5px] border-solid flex flex-row items-start justify-start py-[0.75rem] px-[0rem] whitespace-nowrap z-[1]">
              <div
                class="h-[3.125rem] w-[12.5rem] relative rounded-t-[8px] rounded-b-[0px] bg-[#00acce] border-[#00acce] border-[1.5px] border-solid box-border hidden"></div>
              <b class="flex-1 relative z-[2]">Number of Hospitals</b>
            </div>
            <div
          ...
          <div
            ...
            <div
              ...
              <div
                class="h-[3.125rem] w-[12.5rem] relative rounded-t-[8px] rounded-b-[0px] bg-[#00acce] border-[#00acce] border-[1.5px] border-solid box-border hidden"></div>
              <b class="flex-1 relative z-[2]">Number of Patients</b>
            </div>
            <div
              class="self-stretch relative text-[4.688rem] font-extrabold text-[#00c8d2] z-[1] mq450:text-[2.813rem] mq1050:text-[3.75rem]">
