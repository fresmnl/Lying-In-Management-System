      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                class="self-stretch h-[15rem] relative rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border hidden"
              ></div>
              <div
              ...
              >
                ...
                >
                  <div
                    class="h-[5rem] w-[5.625rem] relative rounded-[8px] bg-[#00c8d2] hidden"
                  ></div>
          ...
          >
            ...
            >
              <div
                class="self-stretch h-[16.75rem] relative rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border hidden"
              ></div>
              <div
              ...
              >
                ...
                >
                  <b class="flex-1 relative z-[1] mq450:text-[1.125rem]"
                    >Ownership</b
                  >
                </div>
                <div
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          >
            ...
            >
              <div
                class="self-stretch h-[13.188rem] relative rounded-[8px] bg-[#ecfcff] border-[#00acce] border-[1.5px] border-solid box-border hidden"
              ></div>
              <div
              ...
              >
                <div
                  class="h-[3.125rem] w-[12.5rem] relative rounded-t-[8px] rounded-b-[0px] bg-[#00acce] border-[#00acce] border-[1.5px] border-solid box-border hidden"
                ></div>
