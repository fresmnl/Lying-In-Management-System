<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r border-gray-200 sm:translate-x-0 bg-[#2d82b5]" aria-label="Sidebar">
   <div id="sidebar-container" class="h-full px-3 pb-4 overflow-y-auto bg-[#2D82B5]">
      <ul class="space-y-6 font-medium text-xl">
         <li>
            <a href="Admin-Dashboard" class="flex items-center p-2 rounded-lg mt-10 hover:text-[#2D82B5] hover:fill-[#2D82B5] dark:hover:bg-[#EDF1F6] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Dashboard') echo ' text-[#2D82B5] fill-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
         ...
         <li>
            <a id="registration" href="Admin-Registration" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" class="flex items-center p-2 rounded-lg hover:fill-[#2D82B5] hover:text-[#2D82B5] dark:hover:bg-[#EDF1F6] group hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Registration') echo ' text-[#2D82B5] fill-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
                                                                                                                                                                                                                                                                                    else echo 'text-white fill-[#fff]' ?>">
         ...
         <li>
            ...
            <ul id="record-dropdown-toggle" class="hidden my-2 space-y-2">
               <li>
                  <a href="Admin-Records-account" class=" hover:text-[#2D82B5] dark:hover:bg-[#EDF1F6] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Records-account') echo 'text-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
                                                                                                                                                         else echo 'text-white'; ?> flex items-center w-full h-10 transition duration-75 rounded-lg p-4 pl-14 group">RHU Account</a>
               </li>
               <li>
                  <a href="Admin-Records-information" class="flex items-center w-full p-4 h-10 transition duration-75 rounded-lg pl-14 group <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Records-information') echo 'text-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
                                                                                                                                                else echo 'text-white'; ?> hover:text-[#2D82B5] dark:hover:bg-[#EDF1F6] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] dark:hover:text-[#2D82B5]">RHU Information</a>

               </li>
               <li>
                  <a href="Admin-Records-numbers" class="flex items-center w-full p-4 h-10 transition duration-75 rounded-lg pl-14 group <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Records-numbers') echo 'text-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
               ...
               <li>
                  <a href="Admin-Records.lying-in-beds" class="flex items-center w-full p-4 h-10 transition duration-75 rounded-lg pl-14 group <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Records.lying-in-beds') echo 'text-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
                                                                                                                                             else echo 'text-white'; ?> hover:text-[#2D82B5] dark:hover:bg-[#EDF1F6] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] dark:hover:text-[#2D82B5]">Lying-in Beds</a>
               </li>
            </ul>
         </li>
         <li>
            ...
            <ul id="account-dropdown-toggle" class="hidden my-2 space-y-2">
               <li>
                  <a href="Admin-Setting-edit-account" class=" hover:text-[#2D82B5] dark:hover:bg-[#EDF1F6] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Setting-edit-account') echo 'text-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
                                                                                                                                                               else echo 'text-white'; ?> flex items-center w-full h-10 transition duration-75 rounded-lg p-4 pl-14 group">Edit Account</a>
               </li>
               <li>
                  <a href="Admin-Setting-archive-records" class="flex items-center w-full p-4 h-10 transition duration-75 rounded-lg pl-14 group <?php if ($_SERVER['REQUEST_URI'] === '/Lying-In-Management-System/main-admin/Admin-Setting-archive-records') echo 'text-[#2D82B5] dark:bg-[#EDF1F6] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)]';
...
<style>
    ...
    @media screen and (max-width: 640px) {
      ...
      #record-dropdown-toggle{
         background-color: rgb(45 130 181);
         position: absolute;
      ...
      #account-dropdown-toggle li{
         font-size: 12px;
      }

      #account-dropdown-toggle li a{
         padding: 0;
         font-weight: bold;
      }
   }
