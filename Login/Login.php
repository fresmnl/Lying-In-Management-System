...
.solution-content-child {
  ...
  .role-selection {
    ...
    gap: 1.25rem;
    z-index: 10; /* Adjusted to ensure it's in front */
      ...
      <d class="form-parent">
        ...
        <div class="role-selection">
          ...
          <div class="password-wrapper">
            ...
            <div class="dropdown-divider-wrapper">
              <div class="dropdown-divider"></div>
            </div>
            <div class="select-role-label">
              <div class="select-a-role">Select a role</div>
            </div>
          </div>
          <div class="dropdown-icon">
            <img class="vector-icon" alt="" src="images/dropdown.svg" />
          </div>
          <div class="dropdown-options">
            <div class="option" data-value="Admin">Admin</div>
            <div class="option" data-value="Health Facility">Health Facility</div>
            <div class="option" data-value="Patient">Patient</div>
          </div>
        </div>
        <div class="footer-container">
          ...
          <input class="password-placeholder" placeholder="Username" type="text" />
        </div>
        ...
        <div class="mask-container-wrapper">
          <button class="mask-container">
            <div class="mask-container-child"></div>
