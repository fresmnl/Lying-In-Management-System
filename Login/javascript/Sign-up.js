...
document
  .getElementById("toggleSexDropdown")
  .addEventListener("click", function () {
...
document
  .getElementById("toggleStatusDropdown")
  .addEventListener("click", function () {
...
document
  .getElementById("toggleAttainmentDropdown")
  .addEventListener("click", function () {
...
document
  .getElementById("toggleStatusDropdown1")
  .addEventListener("click", function () {
...
document
  .getElementById("toggleIdTypeDropdown")
  .addEventListener("click", function () {
