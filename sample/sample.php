...
<head>
    ...
    <style>
        ...
        .sidebar ul li {
            margin-bottom: 2.25rem; /* Space between list items */
        }
        .sidebar ul li a {
            text-decoration: none;
            font-weight: 600;
            color: #ffff;
            display: block; /* Changed to block for full-width links */
            font-size: 1.25rem;
            font-family: 'Lato';
            border-radius: 4px; /* Optional: added rounded corners */
        }
        ...
        .dropdown-content a {
            padding: 10px;
            display: block; /* Ensures links are displayed as block */
        }
        .dropdown-icon {
            cursor: pointer;
        }
    ...
    <div class="sidebar">
        <ul>
            ...
            <li class="dropdown">
                ...
                <a href="#" class="dropdown-icon">Records &#9662;</a>
            ...
            <li class="dropdown">
                ...
                <a href="#" class="dropdown-icon">Account Settings &#9662;</a>
                <div class="dropdown-content">
                    <a href="#about-us">About Us</a>
                    <a href="#about-page">About Page</a>
                </div>
